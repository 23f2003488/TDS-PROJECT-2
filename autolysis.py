...
import argparse
import openai  # Ensure the openai package is installed
...
def main(csv_file, api_token):
    ...
    story = question_llm("Generate a nice and creative story from the analysis", context)

    # Add the generated story to README
    if readme_file:
...
if __name__ == "__main__":
    import sys
    if len(sys.argv) < 3:
        print("Usage: uv run autolysis.py <dataset_path> <your_api_token>")
        sys.exit(1)
